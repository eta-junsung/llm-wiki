...
| 비고 | 현행 02·03은 커스텀보드([[schematic_ble_module_board_v01e00]]) — CON1에 외부 **J-Link V9.3 Plus(69730359)** 물려 플래싱(2026-06-15 실측, ST-Link+pyOCD는 폴백 강등). 절차 → [[st_link_nrf52_flash|플래싱 가이드]] |
