...
nRF52832 SPIS 최대 SCK 클럭을 datasheet(nRF52832 Product Specification)에서 확인하고 wiki ingest — STM32 SPI 9MHz 상향 재시도(`app_spi.c` prescaler /4 복구, STM32 리플래시, PB13 SCK 파형 측정) 전 선결 조건.
