...
- **(04 Nucleo 포팅, tx-dummy 브랜치, 2026-06-16)** NUCLEO-F103RB(STM32F103RBT6)에 04_tx_control 포팅 — N1~N4(.ioc/ld/startup/심볼 교체) + (조건부) HSI 재설정. 선결 게이트: ①CubeMX 재생성 정책(수동 vs 재생성) ②Nucleo X3 HSE 크리스탈 실장 여부. ([[roadmaps/04-tx-control-dummy]] §7)
