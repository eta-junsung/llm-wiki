...
source: LP-AM263P UG SPRUJ85B Table 2-28(J4 pinmux)·Table 2-10(mux)·Table 2-14(I2C) [[raw/lp_am263p_ug/ug_lp-am263p.md]] + MCU+ SDK am263px/pinmux.h + 회로도 [[schematic_lp_am263p]] + 8kw-ev-wpt-tx eta_bsp_gpio/iomux 실측 (2026-06-29)
date: 2026-06-29
---
...
→ **남는 디버그 GPIO는 J4.31(GPIO95).** 8kw가 재사용 디버그 GPIO capability를 J4.31/GPIO95로 추가(`feature/adc-repeater-burst`, commit `ef874d9`).
