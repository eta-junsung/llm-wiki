...
- **UART5는 soft 재배치 문제가 아님 (✗, 2026-06-09 확정).** 생성 TXD 패드가 P15로 맞게 나온 게 기확인이고([[am263p_iomux_force_io_enable]]), UART5 미동작의 실제 원인은 ① `UART_write` 블록 주석화(`eta_uart5.c:159-170`) + ② RS-485 트랜시버(THVD1400 U13) DE/485_EN 제어 미구현 — soft 재배치와 무관. 상세 [[am263p_iomux_force_io_enable]] §결론.
