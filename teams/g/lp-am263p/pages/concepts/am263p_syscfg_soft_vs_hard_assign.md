...
source: 8kw-ev-wpt-tx(adc 브랜치, commit b8b0ad8, 2026-06-08) J3.27/J3.28 ADC 핀 추가 — soft 재배치 사고 진단 + hard assign 수정, 실보드 검증
date: 2026-06-08
---
...
- **UART5도 같은 soft 재배치 문제인지 점검 후보.** 단 UART5는 생성 TXD 패드가 P15로 **맞게 나온 게 기확인**이므로([[am263p_iomux_force_io_enable]]) 다른 원인(RS-485 트랜시버 DE/485_EN)일 공산이 큼. **2026-06-09 점검 예정** — 점검 후 ✓/✗로 갱신.
