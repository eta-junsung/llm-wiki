...
| **S6 블로커 = NP(CC33xx) SPI 비응답 (물리 확인)** — firmware: MISO rd#0/1=0xFFFFFFFF·rd#2~7=0x0. Saleae: MISO(P2.14) flat 0·WLAN_IRQ(P1.8) flat. NP가 데이터선·IRQ 전혀 구동 안 함. `SPI not responsive/CMD_ERR_TIMEOUT`. | R36·R36(cont.) |
