...
**다음 시작점**: **A3 물리량 변환 — I_COIL_SEN · GA_Iin_SEN · GA_Vin 3채널 스케일링 구현 중**.
...
| 신호별 스케일링 (A3) | △ | I_COIL_SEN·GA_Iin_SEN·GA_Vin 3채널 구현 중. Temp_Module1/2 잔여 |
...
- **A3 물리량 변환 진행 중 (3채널)**: I_COIL_SEN·GA_Iin_SEN·GA_Vin 3채널 스케일링 구현 중. **잔여 블로커**: Temp_Module1/2 출력 특성(V/°C) 미입수.
