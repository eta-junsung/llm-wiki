...
| **pwm** | EPWM 전력제어 (인버터 게이트 구동·보호·제어루프) | P0~P4 → [[pwm]] | ✗ 미착수 — ADC 다음 활성 트랙 후보. P0(스펙 확정) 선결 |
...
- **다음 활성 트랙**: `pwm` 작업 호([[pwm]], P0~P4) **신규 등록·미착수** — EPWM 전력제어. ADC A3가 스펙 대기로 막혀 있어 PWM이 다음 진행 트랙 후보. 착수 전 P0(토폴로지·채널·주파수·dead-time 스펙 확정) 선결.
