...
| **gpio** | GPIO 출력 브링업 (485_EN·GD_EN_seed) | G0~G1 → [[gpio]] | ✗ 미시작. 핀맵 확정(485_EN=GPIO91=J5.48, GD_EN_seed=GPIO93=J4.33). 다음 활성 트랙 |
...
- **활성 트랙**: `gpio` 작업 호 — **G0 미시작** (핀맵 확정, 구현 예정). PWM P2까지 완료·다음은 P3 보호(블로커: 보호신호 스펙).
