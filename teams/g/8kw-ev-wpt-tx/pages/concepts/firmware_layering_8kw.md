...
| **ALG** | eta_alg_crc, eta_alg_convert |
...
제어/보호 로직 미착수이므로 ALG가 거의 비어있는 것이 **정상 상태**(표준 §4). 현재 ALG = `eta_alg_convert`(raw→mV, `raw*3300/4095`)·`eta_alg_crc16`(CRC-16/CCITT-FALSE)뿐 — 의도적.
