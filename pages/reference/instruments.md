...
| 연결 대상 | nRF52832 — **02_RX_ble 실측 통과**, 03_TX_ble 적용 가능(절차 동치, 03 flash 실측은 추후) |
...
| 실측 (2026-06-15, 02_RX_ble) | VTref 3.1~3.3 V, SW-DP ID `0x2BA01477`, Cortex-M4 r0p1, FICR `0x10000060`(DEVICEID[0])=`0x5FE168DA`. program+verify 통과 (Bank0@0x0 **57344 B**, Erasing→Programming 100%→Verifying O.K., reset+go, **exit 0**) |
...
> nRF52 DK(PCA10040)는 보드 온보드 J-Link라 외부 프로브가 아니다(있다면 인벤토리 밖). lp-am263p는 TI XDS110 — 해당 프로젝트 페이지 참조.
